...
class OfficeRepository implements BaseRepositoryInterface
{
    ...
    {
        return Office::select('id','office_name_eng','office_name_bng','office_name_eng AS office_name_en','office_name_bng AS office_name_bn')->where('office_ministry_id',$request->office_ministry_id)
