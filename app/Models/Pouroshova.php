...
class Pouroshova extends Model
{
    ...
    protected $fillable= ['geo_division_id','geo_district_id','geo_upazila_id','municipality_name_bng','municipality_name_eng','bbs_code','division_bbs_code','district_bbs_code','upazila_bbs_code','status','id','created_by','modified_by'];
